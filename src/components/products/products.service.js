...
var ProductsService = /** @class */ (function () {
    ...
    ProductsService.prototype.create = function (createProductDto) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.productRepository.save(createProductDto)];
    ...
    ProductsService.prototype.update = function (id, updateProductDto) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.findOne(id).then(function (res) { return res; })];
                    case 1:
                        prod = _a.sent();
                        if (!prod) return [3 /*break*/, 3];
                        return [4 /*yield*/, this.productRepository.update(id, updateProductDto).then(function (res) { return res; })];
